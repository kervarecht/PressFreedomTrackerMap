...
window.onload = function () {
    document.getElementById("svg-target").addEventListener("wheel", function (e) {
        zoom(e);
    });
}
...
//map of the US variable
var rsr = Raphael('svg-target', '959', '593');
var frames = rsr.path("M215 493v55l36 45M0 425h147l68 68h85l54 54v46");
frames.attr({
    id: 'frames',
    fill: 'none',
    stroke: '#A9A9A9',
...
var DC = rsr.set();
var DC1 = rsr.path("M801.8 253.8l-1.1-1.6-1-.8 1.1-1.6 2.2 1.5z").attr({
    id: 'DC1',
    class: 'state',
    parent: 'group_a',
    'stroke-width': '0',
...
var rsrGroups = [group_a, AK, HI, AL, AR, AZ, CA, CO, CT, DE, FL, GA, IA, ID, IL, IN, KS, KY, LA, MA, MD, ME, MI, MN, MO, MS, MT, NC, ND, NE, NH, NJ, NM, NV, NY, OH, OK, OR, PA, RI, SC, SD, TN, TX, UT, VA, VT, WA, WI, WV, WY, DC];
group_a.push();
AK.push();
HI.push();
AL.push();
